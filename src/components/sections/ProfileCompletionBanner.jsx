                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className={`w-7 h-7 rounded-lg border flex items-center justify-center ${isExplore
                            ...
                            <div className="flex items-center gap-2">
                                <h3 className={`text-xs font-bold tracking-wide ${isExplore ? 'text-amber-900' : 'text-zinc-900'}`}>
                        ...
                        <span className="text-[10px] font-bold text-zinc-600">{percentage}% Complete</span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-1">
                        <div className="space-y-1">
                            <p className="text-xs md:text-sm font-medium text-zinc-700 tracking-tight">
                                {isExplore
                                    ? 'You are currently invisible to others. Finish your profile setup to make your profile public and start connecting with others.'
                                    : `Next: Add your ${missingField} to unlock Connection Feature.`
                                }
                            </p>
                        ...
                        >
                            <span className="text-[9px] font-bold tracking-wider">{isExplore ? 'Make Profile Public' : 'Complete Now'}</span>
