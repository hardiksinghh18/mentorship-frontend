...
import { StatCard } from './renderers/statcard.renderer';
...
const Dashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black pt-32 pb-40 px-6 md:px-12">
            <div className="max-w-7xl mx-auto space-y-16">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    <div className="space-y-4">
                        <div className="inline-flex items-center space-x-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full">
                            ...
                            <span className="text-[9px] font-black uppercase tracking-widest text-zinc-400">Account Active</span>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-500">
                    <Link to="/explore" className="group relative bg-white text-black p-10 rounded-[3rem] overflow-hidden transition-all hover:bg-zinc-200 active:scale-[0.98]">
