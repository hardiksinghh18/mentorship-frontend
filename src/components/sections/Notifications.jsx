    ...
    return (
        <div className="bg-black rounded-[2rem] border border-white/[0.03] p-8">
            <div className="flex justify-between items-end mb-10">
                <div>
                    <h2 className="text-[11px] font-black uppercase tracking-[0.3em] text-zinc-600 block mb-2">Notifications</h2>
                    <p className="text-xl font-black text-white tracking-tighter">Pending Requests</p>
                </div>
